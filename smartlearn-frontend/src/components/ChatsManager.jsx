...
export default function ChatsManager({ chatsData, onOpenChat }) {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-card/40 backdrop-blur-2xl relative z-10 overflow-hidden shadow-2xl">
      {/* Header Area */}
      <div className="flex-none px-6 md:px-12 pt-12 pb-6 border-b border-border/40">
